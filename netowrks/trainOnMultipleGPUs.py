#Train single network on multiple GPUs
import sys
import os
...
sys.path.append("/tank/georgioutk/cliffordConvolutionEddy_old/")
...
# train_dir = os.getcwd() + "withValSetSmallTrainSet/8000/2x512_3x128_2x64SkipPytorchBNormEpsilon"+modelType+"/"+run
train_dir = os.getcwd() + "withValSet/2x512_3x128_2x64SkipPytorchBNormEpsilon_nl1e-4"+modelType+"/"+run
...
if __name__ == '__main__':
	...
	totalSteps = int(240*numTrainExamples/batch_size)
