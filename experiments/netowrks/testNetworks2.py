...
# 			print(perGPUValData[gpu][0].get_shape())
# 			print(len(perGPUValData[gpu]))
# 			trainCode = models.inference(perGPUValData[gpu], first=(gpu==0), useType="test", modelType=modelType)
# 			print(valCode.get_shape())
...
allOutputs = tf.reshape(allOutputs, [batch_size, 5, 2])
valPredictions = tf.reduce_mean(allOutputs, axis=1)
