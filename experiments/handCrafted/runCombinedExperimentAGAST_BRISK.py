#For comments see runCombinedExperiment.py
...
try:
	dictionary = pickle.load(open(descriptor+"combinedMyDictionary_"+str(nWords)+".pkl", "rb"))
except FileNotFoundError:
...
log = open(descriptor+"V3combinedMy_"+str(nWords)+".acc", "w")
print("Performance")
print(mean, file=log)
